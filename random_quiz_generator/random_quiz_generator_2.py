...
for quiz_num in range(35):
    # TODO: Create the random_quiz_generator and answer key files.
    quiz_file = open('capitalsquiz%s.txt' % (quiz_num + 1), 'w')
    answer_key_file = open('capitalquiz_answers%s.txt' % (quiz_num + 1), 'w')
    # TODO: Write out the header for the random_quiz_generator.
    ...
    for question_num in range(50):
        ...
        # TODO: Write the question and answer options to the random_quiz_generator file.
